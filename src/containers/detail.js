  ...
  return (
    <>
      ...
      <div className="pt-[115px] px-4 pb-10">
        <div className="max-w-7xl mx-auto mt-4 bg-white rounded-2xl shadow-xl p-6 flex flex-col md:flex-row gap-8">
          {/* Ảnh bìa */}
        ...
        <div className="max-w-7xl mx-auto mt-4 bg-white rounded-2xl shadow-xl p-6 ">
        ...
        <div className="mt-4 max-w-7xl mx-auto rounded-2xl shadow-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="bg-gradient-to-r from-indigo-500 to-sky-300 bg-clip-text text-transparent font-bold flex items-center gap-2 mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
